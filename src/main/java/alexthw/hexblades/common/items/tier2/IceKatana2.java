...
public class IceKatana2 extends IceKatana1 {
    ...
    public IceKatana2(Properties props) {
        super(5, -2.5F, props);
        tooltipText = Component.translatable("tooltip.hexblades.ice_katana2");
    }
    ...
    public void applyHexEffects(ItemStack stack, LivingEntity target, Player attacker, boolean awakened) {
        ...
        if (awakened) {
            target.addEffect(new MobEffectInstance(EidolonPotions.CHILLED_EFFECT.get(), 100, 0));
        }
    }
    ...
    protected void addShiftTooltip(ItemStack stack, List<Component> tooltip) {
        ...
        tooltip.add(Component.literal("Slows and chills enemies"));
    }
}
