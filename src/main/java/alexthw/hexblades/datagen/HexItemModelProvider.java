...
public class HexItemModelProvider extends ItemModelProvider {
    ...
    public HexItemModelProvider(PackOutput output, ExistingFileHelper existingFileHelper) {
        super(output, Hexblades.MODID, existingFileHelper);
    }
    ...
    protected void registerModels() {
        ...
        takeAll(items, i -> i.get() instanceof SwordItem && !(i.get() instanceof IHexblade) && !(i.get() instanceof Lightning_SSwordL1)).forEach(this::handheldItem);
    ...
    private void awakenableItem(RegistryObject<Item> it) {
        ...
        String path = ForgeRegistries.ITEMS.getKey(it.get()).getPath();
